...
func (m *mockClient) Generate(_ string) (string, error)              { return "", nil }
func (m *mockClient) Validate(_, _ string) (bool, error)             { return true, nil }
func (m *mockClient) Aggregate(_ string, _ []string) (string, error) { return "agg", nil }
